...
def autogenerate_api_documentation_script():
    ...
    try:
        ...
        pass
    os.system("python pdoc --html --overwrite --template-dir {0} pyMeasure".format(template_directory))
...
def create_imports_html_script(top_directory,output_directory=None):
    ...
    out_file=open(os.path.join(output_directory,"pyMeasure_Imports.html"),"w")
